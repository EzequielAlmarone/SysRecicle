...
<html lang="pt-br">
    <head>
        ...
        <title>Movimentações por consumidor</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="page-header">
                <h1><i class="fa fa-reorder"></i> Movimentações por consumidor</h1>
            </div>
            ...
            <form role="form" method="get" action="rel1-imprimir.php">
                ...
                <div class="checkbox">
                    <label for="fativo">
                        <input type="checkbox" name="ativo" id="fativo" value="1"> Somente consumidores ativos
                    </label>
                </div>

                <div class="checkbox">
                    <label for="fagrupar">
                        <input type="checkbox" name="agrupar" id="fagrupar" value="1"> Agrupar por Consumidor
                    </label>
                </div>
